                    ...
                    <form method="POST" action="{{ route('admin.branches.update', $branch->id) }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="neighborhood" class="block mt-1 w-full" type="text" name="neighborhood"
                                :value="old('neighborhood', $branch->neighborhood)" required autofocus
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="zip_code" class="block mt-1 w-full" type="text" name="zip_code"
                                :value="old('zip_code', $branch->zip_code)" required autocomplete="zip_code" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="street" class="block mt-1 w-full" type="text" name="street"
                                :value="old('street', $branch->street)" required autocomplete="street" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="number" class="block mt-1 w-full" type="text" name="number"
                                :value="old('number', $branch->number)" required autocomplete="number" />
